...
var config = {
  apiOrigins: {
    production: 'https://young-fjord-19893.herokuapp.com'
  }
};
...
var showAlbumsTemplate = __webpack_require__(18);

var refreshTable = function refreshTable() {
  clearAlbums();
  api.getAlbums().then(getAlbumsSuccess).catch(failure);
};
...
var deleteAlbumSuccess = function deleteAlbumSuccess(data) {
  $('#album-message').show();
...
var createAlbumSuccess = function createAlbumSuccess(data) {
  $('#albummessage').show();
...
var updateAlbumSuccess = function updateAlbumSuccess(data) {
  $('#album-message').show();
...
var deleteAlbum = function deleteAlbum(data) {
  return $.ajax({
...
var updateAlbum = function updateAlbum(data) {
  return $.ajax({
    url: config.apiOrigin + '/albums/' + data.album.id,
    method: 'PATCH',
    headers: {
...
var albumEvents = __webpack_require__(36);
...
/*
  ...
  client remote, api local
    https://ga-wdi-boston.github.io/music-app-frontend/?environment=development
    This will require allowing "unsafe scripts" in Chrome
  client remote, api remote
    https://ga-wdi-boston.github.io/music-app-frontend/
*/
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "      <tr>\n        <td data-id=\""
    ...
    + "        </td>\n        <td>\n"
    + ((stack1 = helpers["if"].call(alias3,((stack1 = blockParams[0][0]) != null ? stack1.year : stack1),{"name":"if","hash":{},"fn":container.program(10, data, 0, blockParams),"inverse":container.program(12, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "        </td>\n      </tr>\n";
...
var onGetAlbums = function onGetAlbums(event) {
  event.preventDefault();
  api.getAlbums().then(ui.getAlbumsSuccess).catch(ui.failure);
};
// submit form buttons
var onDeleteAlbum = function onDeleteAlbum(event) {
  var data = getFormFields(this);
  event.preventDefault();
  api.deleteAlbum(data).then(ui.deleteAlbumSuccess).catch(ui.failure);
};
var onCreateAlbum = function onCreateAlbum(event) {
  var data = getFormFields(this);
  event.preventDefault();
  api.createAlbum(data).then(ui.createAlbumSuccess).catch(ui.failure);
};
var onUpdateAlbum = function onUpdateAlbum(event) {
  var data = getFormFields(this);
  event.preventDefault();
  api.updateAlbum(data).then(ui.updateAlbumSuccess).catch(ui.failure);
};

// buttons to reveal forms
var showFieldDelete = function showFieldDelete() {
  $('#delete-album').show();
  $('#create-album').hide();
  $('#update-album').hide();
};
var showFieldCreate = function showFieldCreate() {
  $('#create-album').show();
  $('#update-album').hide();
  $('#delete-album').hide();
};
var showFieldUpdate = function showFieldUpdate() {
  $('#update-album').show();
  $('#delete-album').hide();
  $('#create-album').hide();
};
